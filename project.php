...
<head>
    <meta charset="utf-8">
    <title>Proyectos | INFOPLAN </title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="login-page/login.php" class="btn btn-secondary text-light rounded-pill py-2 px-4 ms-3">Iniciar Sesión</a>
                </div>
            </nav>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>Ingresa tú correo electrónico para enviarte notificaciones de nosotros</p>
